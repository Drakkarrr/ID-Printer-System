  ...
  if (isset($_POST['snoEdit'])) {
    ...
    if ($name == '' || $id_no == '') {
      ...
      if (mysqli_num_rows($querry) > 0) {
        ...
        $uploadfile2 = $uploaddir . basename($_FILES['signature']['name']);
        ...
        if (move_uploaded_file($_FILES['signature']['tmp_name'], $uploadfile2)) {
        } else {
          echo "Possible file upload attack!\n";
        }
        // Sql query to be executed
        $sql = "INSERT INTO `cards`(`name`, `id_no`, `role`, `email`, `phone`, `blood`,`address`, `dob`, `exp_date`,  `image`, `signature`) VALUES ('$name','$id_no','$role','$email','$phone','$blood','$address','$dob','$exp_date','$uploadfile', '$uploadfile2')";
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputState">Designation / Role</label>
